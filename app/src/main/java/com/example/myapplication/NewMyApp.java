...
public class NewMyApp implements IXposedHookLoadPackage {
    public static final String SP_NAME = "dd_contact";
    public static final String FLAG1566 = "Tue Apr 20 13:37:21 CST 2021";
                                    ...
                                    XposedBridge.hookAllMethods(clzObj, m.getName(), new XC_MethodHook() {
                                        ...
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            ...
                                            if (map1.size() == 0 && clzObj == clzLocalContactAdapter) {
                                                ...
                                                if (o == null || o.size() < 10 || temp.size() > 0) {
                                                    return;
                                                }
