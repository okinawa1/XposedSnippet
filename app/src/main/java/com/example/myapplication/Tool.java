...
public class Tool {
    ...
    public void testSignature() throws PackageManager.NameNotFoundException {
        PackageInfo packageInfo = new Application().getPackageManager().getPackageInfo("", PackageManager.GET_SIGNATURES);
    }
}
